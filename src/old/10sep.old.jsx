...
// https://github.com/hrgdavor/babel-plugin-jsx-simple
...
// function renderDyn() {
//     return <div> <p>akshay is smart</p>
//     <button >
//     </div>
// }
...
// applyHtml('app1', [renderList({data, numbered:true } ), renderDyn()]);
...
//     } else {
//         const n = document.createElement(def.tag);
//         if (def.attr) {
...
console.log(<div id="foo">{text}</div>)
